...
public class TextAnalyser
{
    ...
    {
        "a", "about", "above", "after", "again", "againstall", "am", "anand", "any", "are", "aren't", "as", "at", "be", "because", "been", "before", "being", "below", "between", "both", "but", "bycan't", "cannot",
    ...
    public static String[] fewStopwords =
    {
        "a", "and", "are", "be", "if", "in", "is", "it", "of", "on", "or", "so", "the", "they", "there", "this"
    };
